...
const CreateSchedaPage = ({ onNavigate, user }) => {
    const [schedaParams, setSchedaParams] = useState({
        ...
        type: '',
        duration: '',
        description: ''  // Nuovo campo aggiunto
    });
    ...
    // Aggiungi questo useEffect all'inizio del componente
    useEffect(() => {
        ...
        // Se necessario, aggiorna lo stato locale con i dati dell'utente
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const savedScheda = await createScheda(schedaData);
